...
## Corpus Check
- 260 files · ~344,212 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4847 nodes · 11640 edges · 302 communities (253 shown, 49 thin omitted)
...
- `TestShadcnInstaller` --uses--> `ShadcnInstaller`  [INFERRED]
  .agents/skills/ui-ux-pro-max/.claude/skills/ui-styling/scripts/tests/test_shadcn_add.py → .agents/skills/ui-ux-pro-max/.claude/skills/ui-styling/scripts/shadcn_add.py
...
Cohesion: 0.02
Nodes (158): $(), active(), addControllers(), addElements(), addPlugins(), addScales(), afterBuildTicks(), afterCalculateLabelRotation() (+150 more)
...
Cohesion: 0.07
Nodes (26): 161 Industry-Specific Reasoning Rules, Architecture & Contributing, Available Styles (67), Design System Command (Advanced), Example Prompts, Features, For Contributors, For Users (+18 more)
...
Cohesion: 0.08
Nodes (24): author, bin, uipro, dependencies, chalk, commander, ora, prompts (+16 more)
...
Cohesion: 0.15
Nodes (15): BM25, detect_domain(), _load_csv(), search(), _search_csv(), search_stack(), Lowercase, split, remove punctuation, filter short words, Build BM25 index from documents (+7 more)

### Community 51 - "Community 51"
Cohesion: 0.15
Nodes (15): BM25, detect_domain(), _load_csv(), search(), _search_csv(), search_stack(), BM25 ranking algorithm for text search, Lowercase, split, remove punctuation, filter short words (+7 more)
...
Cohesion: 0.22
Nodes (6): Path, Any, Initialize generator.          Args:             typescript: If True, generat, Determine default output path., Create base configuration structure., Get default content paths for framework.
...
Cohesion: 0.29
Nodes (6): Development, How It Works, Installation, License, uipro-cli, Usage
...
Cohesion: 0.07
Nodes (44): aa(), addBox(), adjustHitBoxes(), afterDraw(), beforeDatasetDraw(), beforeDatasetsDraw(), beforeDraw(), _computeTitleHeight() (+36 more)
...
Cohesion: 0.02
Nodes (134): $(), active(), addControllers(), addElements(), addPlugins(), addScales(), afterAutoSkip(), afterTickToLabelConversion() (+126 more)

### Community 116 - "Community 116"
Cohesion: 0.13
Nodes (38): bc(), beforeLayout(), bl(), cl(), data(), first(), fl(), gc() (+30 more)
...
Cohesion: 0.04
Nodes (138): a(), ac(), add(), ae(), ai(), Ao(), b(), ba() (+130 more)
...
Cohesion: 0.04
Nodes (87): acquireContext(), afterBuildTicks(), afterCalculateLabelRotation(), afterDataLimits(), afterDatasetsUpdate(), afterFit(), afterSetDimensions(), afterUpdate() (+79 more)
...
Cohesion: 0.05
Nodes (71): applyStack(), ba(), buildOrUpdateElements(), _calculateBarIndexPixels(), _calculateBarValuePixels(), calculateCircumference(), _calculatePadding(), calculateTotal() (+63 more)

### Community 184 - "Community 184"
Cohesion: 0.09
Nodes (83): add(), addEventListener(), af(), ai(), at(), b(), bd(), bf() (+75 more)
...
Cohesion: 0.05
Nodes (90): alpha(), ap(), as(), aspectRatio(), configure(), createResolver(), cs(), D() (+82 more)

### Community 187 - "Community 187"
Cohesion: 0.05
Nodes (88): adjustHitBoxes(), afterDraw(), An(), br(), bs(), clear(), clearCache(), cn() (+80 more)

### Community 188 - "Community 188"
Cohesion: 0.09
Nodes (66): aa(), ac(), acquireContext(), apply(), be(), bi(), cc(), ce() (+58 more)
...
Cohesion: 0.06
Nodes (73): ad(), ap(), as(), at(), Au(), bu(), Co(), Cu() (+65 more)

### Community 191 - "Community 191"
Cohesion: 0.06
Nodes (56): buildTicks(), calculateLabelRotation(), _calculatePadding(), _computeGridLineItems(), _computeLabelItems(), computeTickLimit(), determineDataLimits(), diff() (+48 more)

### Community 192 - "Community 192"
Cohesion: 0.12
Nodes (29): Ao(), average(), bo(), Co(), dataset(), dn(), Do(), _eventHandler() (+21 more)

### Community 193 - "Community 193"
Cohesion: 0.05
Nodes (89): a(), ad(), addBox(), ae(), afterAutoSkip(), Al(), Au(), beforeDatasetDraw() (+81 more)
...
Cohesion: 0.09
Nodes (48): addEventListener(), af(), bd(), bt(), _cachedScopes(), cf(), de(), df() (+40 more)

### Community 233 - "Community 233"
Cohesion: 0.08
Nodes (40): Al(), beforeLayout(), bl(), cl(), dl(), drawBackground(), drawCaret(), ea() (+32 more)
...
Cohesion: 0.14
Nodes (21): cr(), cs(), easeInOutElastic(), Ed(), en(), Gn(), Hn(), Jn() (+13 more)
...
Cohesion: 0.12
Nodes (15): Project Structure Flattening, 1. Exposition Directe du State Setter React dans l'Iframe, 1. Simplification de la Structure du Projet (Flattening), 2. Centrage du Menu de Navigation, 2. Résolution du Bug d'Accès à la Base de Données, 3. Correction de l'Affichage et du Défilement des Onglets (Points Hauts / Perroquets), 3. Masquage CSS Flexible de la Sidebar Héritée, 4. Correction de l'Animation de Soulignement Rouge (Framer Motion) (+7 more)
...
## Knowledge Gaps
- **1184 isolated node(s):** `$schema`, `$value`, `$type`, `$value`, `$type` (+1179 more)
...
- **Why does `$()` connect `Community 115` to `Community 232`, `Community 105`, `Community 233`, `Community 240`, `Community 178`, `Community 242`, `Community 180`, `Community 185`, `Community 190`, `Community 191`?**
